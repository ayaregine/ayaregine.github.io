          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Add assignees entries</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br />
                    <form id="juansumbongform" data-parsley-validate class="form-horizontal form-label-left" action="persistdataassignees.php" method="POST" enctype="multipart/form-data">

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="juansumbongname">Assignee name<span class="required">*</span>
                        </label>
					  ...
					  <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Gov't Office <span class="required">*</span> </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select id="juansumbonggovtoffice" name="juansumbonggovtoffice" class="form-control col-md-7 col-xs-12">
                            <?php
							...
							$result = mysqli_query($con,"SELECT * FROM `js_offices` ");
					  ...
					  <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="juansumbongusername">Username<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="juansumbongusername" name="juansumbongusername" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
					
					<div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="juansumbongpassword">Password<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="password" id="juansumbongpassword" name="juansumbongpassword" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
					...
					<table id="tbjuan" class="table table-striped jambo_table bulk_action">
					 <thead>
					  ...
					  <?php
							...
							$result = mysqli_query($con,"SELECT * FROM `js_assignees`");
							...
							while($row = mysqli_fetch_array($result))
							{
								...
								echo '<td>'.$row["id"].'</td>';
								echo '<td>'.$row["name"].'</td>';
								$conn=mysqli_connect("localhost","root","","juansumbong","3307");
								// Check connection
								if (mysqli_connect_errno())
								{
								echo "Failed to connect to MySQL: " . mysqli_connect_error();
								...
								$officeid = $row["office"];
								$results = mysqli_query($conn,"SELECT `name` FROM `js_offices` where id='$officeid' ");
