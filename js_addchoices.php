          ...
          <div class="left_col scroll-view">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              ...
              <div class="menu_section">
                <h3>Others</h3>
                <ul class="nav side-menu">
				  <li><a href="http://localhost/juansumbong/application/admin.php"><i class="glyphicon glyphicon-off"></i>  Logout</a></li>
				 </ul>
              </div>
            </div>
            <!-- /sidebar menu -->
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="juansumbongform" data-parsley-validate class="form-horizontal form-label-left" action="persistdatachoices.php" method="POST" enctype="multipart/form-data">

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="juansumbongquestion">Security question choices <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="juansumbongchoices" name="juansumbongchoices" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
					...
					<table id="tbjuan" class="table table-striped jambo_table bulk_action">
					 <thead>
					  ...
					  <?php
							...
							$result = mysqli_query($con,"SELECT `id`,`choices` FROM `js_choices`");
