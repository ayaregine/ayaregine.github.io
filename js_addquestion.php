            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="juansumbongform" data-parsley-validate class="form-horizontal form-label-left" action="persistdataquestion.php" method="POST" enctype="multipart/form-data">

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="juansumbongquestion">Question <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="juansumbongquestion" name="juansumbongquestion" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
					  
					   <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="juansumbonganswer">Answer <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="juansumbonganswer" name="juansumbonganswer" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
					...
					<table id="tbjuan" class="table table-striped jambo_table bulk_action">
					 <thead>
					  ...
					  <?php
							...
							$result = mysqli_query($con,"SELECT `id`,`question`,`answer` FROM `js_securityquestion`");
