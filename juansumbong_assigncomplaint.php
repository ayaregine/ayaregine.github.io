          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Juan Sumbong Unassigned Complaint<small> This shows the list of unassigned complaints</small></h2>                   
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                  ...
                  <form action="juansumbong_formassignee.php" method="GET">
					...
					<?php
							...
							$result = mysqli_query($con,"SELECT `id`,`juansumbongtitlecomplaint`, `juansumbongtypeofcomplaint`,  `juansumbongmessage`, `resolved`, `datefiled`,`juansumbonggovtoffice`,`assignee` FROM `js_complaint` WHERE `juansumbonggovtoffice` = 'notyetassigned' OR `assignee` = 'none' ");
