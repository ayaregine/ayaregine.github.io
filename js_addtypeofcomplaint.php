          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Add nature of complaint entries</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br />
                    <form id="juansumbongform" data-parsley-validate class="form-horizontal form-label-left" action="persistdatatypeofcomplaint.php" method="POST" enctype="multipart/form-data">

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="juansumbongtypeofcomplaint">Nature of complaint<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="juansumbongtypeofcomplaint" name="juansumbongtypeofcomplaint" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
					...
					<table id="tbjuan" class="table table-striped jambo_table bulk_action">
					 <thead>
					  ...
					  <?php
							...
							$result = mysqli_query($con,"SELECT `id`,`natureofcomplaint` FROM `js_natureofcomplaint`");
							...
							while($row = mysqli_fetch_array($result))
							{
								echo '<tr>';
								echo '<td>'.$row["id"].'</td>';
								echo '<td>'.$row["natureofcomplaint"].'</td>';
								echo '</tr>';
							}
